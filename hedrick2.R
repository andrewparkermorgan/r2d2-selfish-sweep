...
fixprobs <- rez
save(fixprobs, params, file = "~/Dropbox/R2d2_selective_sweep/work/hedrick.fixprobs.Rdata")
...
fixtime <- rbind( transform(read.table("~/Dropbox/R2d2_phylogeny/simtrd/n100.t5.s80.p80.m0.txt", header = TRUE), model = "m0", freq = 0),
				  transform(read.table("~/Dropbox/R2d2_phylogeny/simtrd/n100.t5.s80.p80.m4.txt", header = TRUE), model = "m4", freq = 0.01),
				  transform(read.table("~/Dropbox/R2d2_phylogeny/simtrd/n100.t5.s80.p80.m3.txt", header = TRUE), model = "m3", freq = 0.1),
				  transform(read.table("~/Dropbox/R2d2_phylogeny/simtrd/n100.t5.s80.p80.m1.txt", header = TRUE), model = "m1", freq = 0.2),
				  transform(read.table("~/Dropbox/R2d2_phylogeny/simtrd/n100.t5.s80.p80.m2.txt", header = TRUE), model = "m2", freq = 0.5) )
...
onerun <- read.table("~/Dropbox/R2d2_phylogeny/simtrd/collapse.example.txt", header = TRUE)
...
pdf("~/Dropbox/R2d2_selective_sweep/figures/fixation.probs.pdf", width = 12, height = 6)
